...
public interface ClickMobsConfig {
    ...
    ConfigOption<Boolean> ONLY_FRIENDLY_MOBS =
            CONFIG.option("only_friendly_mobs", false)
                    .header("""
                            ---------------------------------------------------------
    ...
    ConfigOption<Boolean> REQUIRE_EMPTY_HAND =
            CONFIG.option("require_empty_hand", false)
                    .description("""
